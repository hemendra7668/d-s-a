...
public class Interfac {
    public static void main(String[] args) {
        ...
        //lambda notation for the interface methods, the interface should be the functional interce
        INTERFACE i= () -> {
        ...
        // we can also control the return type and the arguments pass in a interface using the generics and can say dynamic return and args
